...
const Card = ({ticket, setSelectedTicket=()=>{}, setShowModal=()=>{}}) => {
  const handleCancelClick = () => {
    setSelectedTicket(ticket);
    setShowModal(true);
  };
  return (
    <div className="card" onClick={handleCancelClick}>
      <header className="card-header">
        ...
        <span className="title">{ticket.f_name}</span>
      </header>
      {/* <div style={{height:"90%"}}><span></span></div> */}
        <div style={{padding:'10px'}}></div>
      <div style={{width:'90%',display: 'flex', justifyContent:'center', alignContent:'center'}}>
        <svg fill="#ffffff" width="80px" height="80px" viewBox="0 0 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{ enableBackground: 'new 0 0 122.88 122.88' }} xmlSpace="preserve">
      ...
      <div className="card-author">
        ...
        <div className="author-name">
          <div className="author-name-prefix">{ticket.name}</div> Age: {ticket.age}
        </div>
      </div>
      <div className="tags">
        <a >from: {ticket.f_from}</a>
        <a >to: {ticket.f_to}</a>
        {/* <a >{}</a> */}
      </div>
